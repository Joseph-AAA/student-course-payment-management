...
export const initialCourses = [
  { id: 1, title: "JavaScript Fundamentals", category: "Web Development", level: "Beginner", duration: "8 weeks", price: "RM 899", students: 110, icon: "JS",color: "bg-yellow-400", bgcolor: "bg-yellow-400/30", textColor: "text-yellow-600", status: "Published", description: "Master JavaScript from the ground up. This course covers variables, functions, arrays, objects, and DOM manipulation.", rating: 4.8, totalLessons: 48, instructor: { name: "John Doe", title: "Senior Developer" } },
  { id: 2, title: "React.js Bootcamp", category: "Web Development", level: "Intermediate", duration: "10 weeks", price: "RM 899", students: 85, icon: "⚛️", color: "bg-blue-400", bgcolor: "bg-blue-400/30", textColor: "text-blue-600", status: "Published", description: "Learn React from scratch and build real-world applications with modern tools and best practices.", rating: 4.9, totalLessons: 62, instructor: { name: "Jane Smith", title: "Frontend Architect" } },
  ...
  { id: 4, title: "TypeScript Essentials", category: "Web Development", level: "Beginner", duration: "8 weeks", price: "RM 499", students: 45, icon: "TS",color: "bg-blue-500", bgcolor: "bg-blue-500/30", textColor: "text-blue-600", status: "Published", description: "Master TypeScript for safer, more maintainable JavaScript applications with static typing.", rating: 4.6, totalLessons: 40, instructor: { name: "Sarah Wilson", title: "Fullstack Developer" } },
